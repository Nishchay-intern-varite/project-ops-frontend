...
import { createIsHighlighted } from "./createIsHighlighted.mjs";
import { createIsFaded } from "./createIsFaded.mjs";
import { getSeriesHighlightedItem, getSeriesUnfadedItem, isSeriesFaded, isSeriesHighlighted } from "./highlightStates.mjs";
...
export const selectorChartsHighlightedItem = createSelectorMemoized(selectHighlight, selectorChartsKeyboardItem, function selectorChartsHighlightedItem(selectorHighlight, keyboardItem) {
  return selectorHighlight.isControlled || selectorHighlight.lastUpdate === 'pointer' ? selectorHighlight.item : keyboardItem;
});
