...
export declare const selectorAllSeriesOfType: (args_0: import("./plugins/corePlugins/useChartId/useChartId.types.mjs").UseChartIdState & import("./plugins/corePlugins/useChartExperimentalFeature/useChartExperimentalFeature.types.mjs").UseChartExperimentalFeaturesState & import("./plugins/corePlugins/useChartDimensions/useChartDimensions.types.mjs").UseChartDimensionsState & import("./plugins/corePlugins/useChartSeries/useChartSeries.types.mjs").UseChartSeriesState<keyof ChartsSeriesConfig> & import("./plugins/corePlugins/useChartAnimation/useChartAnimation.types.mjs").UseChartAnimationState & import("./index.mjs").UseChartInteractionListenerState & Partial<{}> & {
  ...
  series: Record<SeriesId, import("../index.mjs").DefaultizedScatterSeriesType>;
  seriesOrder: SeriesId[];
} | {
  series: Record<SeriesId, import("../index.mjs").DefaultizedPieSeriesType>;
  seriesOrder: SeriesId[];
} | {
  series: Record<SeriesId, import("../index.mjs").DefaultizedRadarSeriesType>;
  seriesOrder: SeriesId[];
} | undefined;
export declare const selectorSeriesOfType: (args_0: import("./plugins/corePlugins/useChartId/useChartId.types.mjs").UseChartIdState & import("./plugins/corePlugins/useChartExperimentalFeature/useChartExperimentalFeature.types.mjs").UseChartExperimentalFeaturesState & import("./plugins/corePlugins/useChartDimensions/useChartDimensions.types.mjs").UseChartDimensionsState & import("./plugins/corePlugins/useChartSeries/useChartSeries.types.mjs").UseChartSeriesState<keyof ChartsSeriesConfig> & import("./plugins/corePlugins/useChartAnimation/useChartAnimation.types.mjs").UseChartAnimationState & import("./index.mjs").UseChartInteractionListenerState & Partial<{}> & {
  cacheKey: import("./index.mjs").ChartStateCacheKey;
}, seriesType: keyof ChartsSeriesConfig, ids?: SeriesId | SeriesId[] | undefined) => import("../index.mjs").DefaultizedLineSeriesType | import("../index.mjs").DefaultizedBarSeriesType | import("../index.mjs").DefaultizedScatterSeriesType | import("../index.mjs").DefaultizedPieSeriesType | import("../index.mjs").DefaultizedRadarSeriesType | (import("../index.mjs").DefaultizedLineSeriesType | import("../index.mjs").DefaultizedBarSeriesType | import("../index.mjs").DefaultizedScatterSeriesType | import("../index.mjs").DefaultizedPieSeriesType | import("../index.mjs").DefaultizedRadarSeriesType | undefined)[] | undefined;
