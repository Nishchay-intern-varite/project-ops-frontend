...
import { type CommonDefaultizedProps, type CommonSeriesType, type SeriesId } from "./common.mjs";
...
export type DefaultizedPieValueType = PieValueType & Omit<D3PieArcDatum<any>, 'data' | 'hidden'> & {
  color: string;
