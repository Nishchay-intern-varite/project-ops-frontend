...
import { selectorChartsInteractionAxisTooltip } from "../internals/plugins/featurePlugins/useChartCartesianAxis/index.mjs";
...
import { useSvgRef } from "../hooks/index.mjs";
...
function ChartsTooltipContainer(inProps) {
  ...
  return /*#__PURE__*/_jsxs(React.Fragment, {
    children: [svgRef.current && /*#__PURE__*/ReactDOM.createPortal(/*#__PURE__*/_jsx("rect", _extends({
      ref: anchorRef
    }, itemPosition, {
      display: "hidden"
